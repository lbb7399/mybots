...
def Send_Cube(name="default",pos=[0,0,0],size=[1,1,1],colorString='<color rgba="0 1.0 1.0 1.0"/>'):

    Send_Link(name,pos,size,"box",colorString)

def Send_Sphere(name="default",pos=[0,0,0],size=[0.5],colorString='<color rgba="0 1.0 1.0 1.0"/>'):
